...
export function TableHead({
  ...
  return (
    <th
      className={cn(
        "h-12 whitespace-nowrap px-4 align-middle [&:has([role=checkbox])]:pr-0",
        alignmentClass,
        className,
      )}
      {...props}
    >
      <div
        className={cn(
          "flex items-center gap-1 font-medium text-neutral-700 dark:text-neutral-100",
          justifyClass,
        )}
      >
        {children}
...
export function TableCell({
  ...
  return (
    <td
      className={cn(
        "p-4 align-middle text-neutral-700 dark:text-neutral-100 [&:has([role=checkbox])]:pr-0",
        className,
      )}
      {...props}
    />
